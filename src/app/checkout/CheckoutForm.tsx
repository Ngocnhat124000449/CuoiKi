...
export default function CheckoutForm() {
  ...
  async function handleApplyCoupon() {
    ...
    const result = await applyCouponAction(couponCode, totalPrice)
            ...
            {appliedCoupon ? (
              <div className={styles.couponApplied}>
                <div className={styles.couponInfo}>
                  ...
                  <div>
                    <p className={styles.couponName}>{appliedCoupon.name}</p>
                    <p className={styles.couponCode}>{appliedCoupon.code}</p>
                  </div>
                  <span className={styles.couponSaving}>−{fmt(appliedCoupon.discountAmount)}</span>
                </div>
