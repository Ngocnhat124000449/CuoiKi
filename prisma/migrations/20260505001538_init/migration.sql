...
CREATE TABLE "product_attribute_values" (
    ...
    CONSTRAINT "product_attribute_values_pkey" PRIMARY KEY ("productId","attributeId","valueId")
);
...
-- AddForeignKey
ALTER TABLE "product_attribute_values" ADD CONSTRAINT "product_attribute_values_valueId_fkey" FOREIGN KEY ("valueId") REFERENCES "attribute_values"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
